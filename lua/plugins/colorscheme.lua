...
function M.config()
	...
	hl("FloatBorder", _G.color.base01, _G.color.base00)
	...
	hl("MasonHeader", _G.color.base05, _G.color.base00)

	-- Lazy
	hl("LazyNormal", _G.color.base05, _G.color.base00)
	hl("LazyReasonCmd", _G.color.base08)
	hl("LazyReasonEvent", _G.color.base09)
	hl("LazyReasonImport", _G.color.base0C)
